...
distancia a todos los puntos de recogida de basuras. Es el algoritmo correspondiente a la sección 4.1 del TFG. Para 
utilizar los grafos de tamaño 50, 200 y 1000 de prueba están en el GitHub en formato string. Hay que convertirlos a 
grafo con la función string-a-grafo(). string-a-grafo() devuelve una dupla que son los parámetros de entrada de esta 
función.
